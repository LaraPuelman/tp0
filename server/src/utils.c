...
int iniciar_servidor(void)
{
	...
	// la función memset is used to fill a block of memory with a particular value.
	...
	if (err != 0) {
		printf("Error en la getaddrinfo del cliente: %s", gai_strerror(err));
		exit(-1);
	}
